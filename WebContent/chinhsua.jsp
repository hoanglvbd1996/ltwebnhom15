          ...
          <div class="modal-body">
            ...
            <%if(rs.next()){ %>
            	<form method="post" action="chinhsuaxoasubmit.jsp?option=edit&value=thongbao">
                      ...
                      <div class="col-lg-8">
                      	  <h4>Nội dung</h4><p><textarea class="form-control" rows="15" name="noidung"><%=rs.getString("noidung")%></textarea></p>
                      	 <h4>Trích đoạn</h4><p><textarea class="form-control" rows="5" name="trichdoan"><%=rs.getString("trichdoan")%></textarea></p>
                      </div>   
               	   <div class="modal-footer">

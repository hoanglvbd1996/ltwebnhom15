...
<body>
   ...
   <div class="row">
                <div class="col-md-8">
                  <% 
				    try{
						String sSQL ="select  top 3  * , mahd as ID  from HoatDong  where donvitochuc =N'Đoàn khoa' order by tgbatdau DESC;";		
				...
				<div class="container-fluid">
  				 <% 
				    try{
						String sSQL ="select * , mahd as ID  from HoatDong  where donvitochuc =N'Đoàn khoa' order by tgbatdau DESC;";		
					    rs = stat.executeQuery(sSQL);
					%>
					 <% while(rs.next()){ %>
					<div class="row">

                                        	...
                                        	<tr>	
                                            	...
                                            	<td><%=rs.getString("tentb") %></td>
                                      			 ...
                                      			 <td><%=rs.getString("idnguoidang") %></td>
                                       			 <td><a href="chitietthongbao.jsp?matb=<%=rs.getString("matb")%>">Xem chi tiết</a></td>
                                                  <td><a href="chinhsua.jsp?matb=<%=rs.getString("matb")%>&option=edit&value=thongbao">Chỉnh sửa</a></td>
                                                 <td><a  href="chinhsuaxoasubmit.jsp?matb=<%=rs.getString("matb")%>&option=delete&value=thongbao">Xóa</a></td>
                                            </tr>
                                            <%} %>
                                        </tbody>
                                    </table>
            	...
            	<form method="post" action="them.jsp?value=thongbao&option=add&id=<%=session.getAttribute("username")%>">
                      <div class="col-lg-4">
                        <h4>Tên thông báo</h4><p><input class="form-control" type="text" name="tentb"></p>
                         <h4>Trích đoạn</h4><p><textarea class="form-control" rows="5" name="trichdoan"></textarea></p>
                         <p><input class="form-control" type="hidden" name="idnguoidang"></p>
                          <h4>Thời gian</h4><p><input class="form-control" type="date" name="thoigian"></p>
                      </div>
                      <div class="col-lg-8">
                      	 <h4>Nội dung</h4><textarea class="form-control" rows="15" name="noidung"></textarea>
                      </div>   
